...
class _EditPage extends State<EditPage> {
  ...
  void initState() {
    ...
    _user_name.value = TextEditingValue(text: widget.user!.username.toString());
    _user_tripname.value = TextEditingValue(text: widget.user!.tripname.toString());
    _user_route_date.value = TextEditingValue(text: widget.user!.routedate.toString());
