...
import 'package:google_mao/screens/pick_up.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Duration: 15 mins', // Replace with actual trip duration
                    style: TextStyle(fontSize: 18),
                  ),
                  Text(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => PickUpScreen()));// Handle 'Iniciar Ruta' button press
                    },
